  ...
  <div class="cn-page">
    ...
    <div class="cn-drawer" :class="{open:drawerOpen}">
      ...
      <div class="cn-dbody">
        ...
        <div class="cn-section-title">Items to Credit</div>
        ...
        <div class="cn-field">
          ...
          <textarea v-model="form.notes" rows="2" class="cn-input" placeholder="Internal note (optional)…"></textarea>
        </div>
      </div>
...
.cn-drawer { position: fixed; top: 0; right: -580px; bottom: 0; width: 580px; max-width: 96vw; background: #fff; border-left: 1px solid #e5e7eb; box-shadow: -8px 0 24px rgba(0,0,0,.08); z-index: 50; display: flex; flex-direction: column; transition: right .22s ease; }
...
.cn-dfooter { display: flex; align-items: center; justify-content: flex-end; gap: 8px; padding: 14px 20px; border-top: 1px solid #e5e7eb; flex-shrink: 0; flex-wrap: wrap; }
